...
public class AddSupplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Supplying Food:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code hereins
        insertS();
    ...
    public static void main(String args[]) {
     ...
     public void insertS ()
    {
        String query="insert into suppliers (`Suppliers ID`,`Suppliers Name`,`Contact NO`,`Supplying Fruit`) Values('"+this.jTextField1.getText()+"','"+this.jTextField2.getText()+"','"+this.jTextField3.getText()+"','"+this.jTextField4.getText()+"') ";
        Connection con=null;
        Statement st = null;
