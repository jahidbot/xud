...
public class LogIn extends javax.swing.JFrame {
    ...
    {
        String query="select * from user where userId='"+this.jTextField1.getText()+"' and password='"+this.jPasswordField1.getText()+"'";
        Connection con=null;
        Statement st = null;
        ResultSet rs = null;
        ...
        try
	{
			...
			while(rs.next())
			{
				...
				if(userId.equals(this.jTextField1.getText()) && password.equals(this.jPasswordField1.getText()))
				{
					...
					{
						HomeEmployee h=new HomeEmployee(branchName,userId);
                                                h.setVisible(true);
						this.setVisible(false);
					}
					else{}
